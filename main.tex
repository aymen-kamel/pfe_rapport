...
\usepackage[french,arabic,english,bidi=default]{babel}
\babelfont[arabic]{rm}[Script=Arabic,Language=Arabic]{Arial}
\babelfont[arabic]{sf}[Script=Arabic,Language=Arabic]{Arial}
\babelfont[arabic]{tt}[Script=Arabic,Language=Arabic]{Courier New}
...
\titlespacing*{\section}{0pt}{2.5ex plus .2ex minus .2ex}{1.2ex plus .1ex}
\titlespacing*{\subsection}{0pt}{2ex plus .2ex minus .2ex}{1ex plus .1ex}
\titlespacing*{\subsubsection}{0pt}{1.5ex plus .1ex minus .1ex}{0.8ex plus .1ex}

\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{\small\nouppercase{\leftmark}}
\fancyhead[R]{\small \textbf{SmartPlayAI}}
\fancyfoot[L]{\small FSS}
...
% ------------------ Chapters ------------------
\input{introduction_generale.tex}
\input{chapitre1 (2).tex}
\input{Chapitre2.tex}
\input{chapitre3.tex}
\input{conclusion_generale.tex}
