...
Cette section a pour objectif d'évaluer la capacité de SmartPlay à répondre aux
...
La validation de SmartPlay a été réalisée à travers une série de scénarios
...
principales fonctionnalités développées au sein de SmartPlay. Les scénarios
...
(sans GPU dédié), à l'aide des modèles utilisés en production : YOLOv8 pour la
...
\begin{table}[H]
  ...
  \begin{tabularx}{\textwidth}{X C{2.2cm} C{2.2cm} C{2.2cm}}
    ...
    Détection joueurs — YOLOv8 (\texttt{imgsz=1280}) & 794,7 & 669,2 & 660,7 \\
    \rowcolor{rowalt}
...
% ────────────────────────────────────────────────────────────────────────────
\subsection{Forces et Contributions de SmartPlay}
% ────────────────────────────────────────────────────────────────────────────

SmartPlay présente plusieurs contributions originales par rapport aux solutions
...
\begin{table}[H]
  ...
  \begin{tabularx}{\textwidth}{X C{2.5cm} C{2.8cm} C{2.5cm}}
    ...
    \rowcolor{rowalt}
    Détection joueurs — YOLOv8        &  795  & $\sim$18 & $\times$44 \\
...
capacités et élargir le champ d'application de SmartPlay.
