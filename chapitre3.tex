...
\begin{table}[H]
  ...
  \begin{tabularx}{\textwidth}{L{3.5cm} X}
    \toprule
    \rowcolor{tablehead}
    \textcolor{white}{\textbf{Indicateur}} & \textcolor{white}{\textbf{Signification}} \\
    \midrule
    \rowcolor{rowalt}
...
\begin{table}[H]
  ...
  \begin{tabularx}{\textwidth}{L{3.2cm} X C{1.5cm}}
    \toprule
    \rowcolor{tablehead}
    \textcolor{white}{\textbf{Métrique}} & \textcolor{white}{\textbf{Description}} & \textcolor{white}{\textbf{Unité}} \\
    \midrule
    \rowcolor{rowalt}
