...
\begin{table}[H]
  \centering
  \tablestyle
  \begin{tabularx}{\textwidth}{C{1.2cm} X C{2.2cm}}
    \toprule
    \rowcolor{tablehead}
    \textcolor{white}{\textbf{ID}} & \textcolor{white}{\textbf{Fonctionnalité}} & \textcolor{white}{\textbf{Priorité}} \\
    \midrule
    \rowcolor{rowalt}
    ...
    \rowcolor{rowalt2}
    F06 & Suivi  de l'état du traitement (journal de mission) & Haute \\
    \bottomrule
  \end{tabularx}
...
\begin{table}[H]
  ...
  \begin{tabularx}{\textwidth}{L{3cm} L{4.5cm} X}
    \toprule
    \rowcolor{tablehead}
    \textcolor{white}{\textbf{Composant}} & \textcolor{white}{\textbf{Spécification}} & \textcolor{white}{\textbf{Rôle dans le projet}} \\
    \midrule
    \rowcolor{rowalt}
    CPU & Intel Core i7 (12\textsuperscript{e} génération) & Traitement des flux vidéo et logique applicative \\
    \rowcolor{rowalt2}
    GPU & NVIDIA RTX 3060 (12 Go VRAM) & Inférence YOLO, TrackNet, SAM2 \\
    \rowcolor{rowalt}
    RAM & 16 Go DDR5 & Chargement des frames vidéo en mémoire tampon \\
    \rowcolor{rowalt2}
    Stockage & SSD NVMe 512 Go & Lecture/écriture des fichiers vidéo et résultats \\
    \rowcolor{rowalt}
    OS & Windows 11 / Ubuntu 22.04 & Environnement de développement dual-boot \\
    \rowcolor{rowalt2}
    Caméra & Drone 4K (vue aérienne, 30 FPS) & Source des vidéos de match à analyser \\
    \bottomrule
  \end{tabularx}
...
\begin{table}[H]
  ...
  \begin{tabularx}{\textwidth}{L{2.8cm} C{2cm} X}
    \toprule
    \rowcolor{tablehead}
    \textcolor{white}{\textbf{Technologie}} & \textcolor{white}{\textbf{Version}} & \textcolor{white}{\textbf{Usage}} \\
    \midrule
    \rowcolor{rowalt}
...
\begin{description}[leftmargin=2.2em, labelwidth=1.8em, font=\bfseries\color{smartblue}]
  ...
  \item[Zone 5 — État de mission]
        Journal de mission affichant  les messages de log du
...
Pendant l'exécution du pipeline, la zone \textit{Mission Status} affiche  les
...
\begin{table}[H]
  ...
  \begin{tabularx}{\textwidth}{L{3.5cm} X}
    ...
    \rowcolor{rowalt}
    Intensity Index & Score composite calculé à partir de la vitesse moyenne et de la densité des échanges \\
  \end{tabularx}
...
Affichage du score  entre \textbf{Team Gold} (Opérateurs 3 \& 4) et
...
\begin{table}[H]
  ...
  \begin{tabularx}{\textwidth}{X C{2.2cm} C{2.2cm} C{2.2cm}}
    \toprule
    \rowcolor{tablehead}
    \textcolor{white}{\textbf{Module}} & \textcolor{white}{\textbf{720p (ms)}} & \textcolor{white}{\textbf{1080p (ms)}} & \textcolor{white}{\textbf{4K (ms)}} \\
    \midrule
    \rowcolor{rowalt}
    ...
    \midrule
    \rowcolor{tablehead}
    \textcolor{white}{\textbf{Total pipeline / image}} & \textcolor{white}{\textbf{2\,461,9}} & \textcolor{white}{\textbf{2\,129,5}} & \textcolor{white}{\textbf{2\,100,3}} \\
    \rowcolor{tablehead}
    \textcolor{white}{\textbf{FPS équivalent (CPU)}} & \textcolor{white}{\textbf{0,4}} & \textcolor{white}{\textbf{0,5}} & \textcolor{white}{\textbf{0,5}} \\
    \bottomrule
  \end{tabularx}
...
\begin{table}[H]
  ...
  \begin{tabularx}{\textwidth}{L{3.5cm} C{2.5cm} C{3.5cm} X}
    \toprule
    \rowcolor{tablehead}
    \textcolor{white}{\textbf{Résolution}} & \textcolor{white}{\textbf{FPS source}} & \textcolor{white}{\textbf{Qualité de détection}} & \textcolor{white}{\textbf{Recommandation}} \\
    \midrule
    \rowcolor{rowalt}
...
\begin{table}[H]
  ...
  \begin{tabularx}{\textwidth}{X C{2.5cm} C{2.8cm} C{2.5cm}}
    \toprule
    \rowcolor{tablehead}
    \textcolor{white}{\textbf{Module}} & \textcolor{white}{\textbf{CPU (ms)}} & \textcolor{white}{\textbf{GPU estimé (ms)}} & \textcolor{white}{\textbf{Accélération}} \\
    \midrule
    \rowcolor{rowalt}
    ...
    \midrule
    \rowcolor{tablehead}
    \textcolor{white}{\textbf{Total pipeline}} & \textcolor{white}{\textbf{2\,462}} & \textcolor{white}{\textbf{$\sim$55}} & \textcolor{white}{\textbf{$\times$45}} \\
    \rowcolor{tablehead}
    \textcolor{white}{\textbf{FPS effectif}} & \textcolor{white}{\textbf{0,4\,FPS}} & \textcolor{white}{\textbf{$\sim$18\,FPS}} & \textcolor{white}{\textbf{—}} \\
    \bottomrule
  \end{tabularx}
...
\begin{table}[H]
  ...
  \begin{tabularx}{\textwidth}{L{3.5cm} C{2.5cm} X L{4cm}}
    \toprule
    \rowcolor{tablehead}
    \textcolor{white}{\textbf{Situation}} & \textcolor{white}{\textbf{Luminosité (lux)}} & \textcolor{white}{\textbf{Effet sur le pipeline}} & \textcolor{white}{\textbf{Réglage recommandé}} \\
    \midrule
    \rowcolor{rowalt}
