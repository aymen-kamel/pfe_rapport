... ainsi, un rebond se manifeste naturellement comme un maximum local de cette coordonnée.\chapter{Architecture de la solution}
...
SmartPlay. Son rôle fondamental est de transformer les coordonnées brutes des joueurs et de
...
situés en aval de la plateforme SmartPlay :
...
Le module d'analyse biomécanique et tactique constitue le pivot analytique de SmartPlay.
