...
\begin{itemize}
    \item \textbf{Extension multi-sports :} adaptation du système vers d'autres sports de raquette tels que le tennis et le squash, en généralisant les modèles de détection et en adaptant les règles de l'automate de scoring. Cette approche modulaire réutiliserait le cœur de l'architecture tout en adaptant les briques métier.
